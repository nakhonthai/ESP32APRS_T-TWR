...
#define LED_RX_ON() {strip.setPixelColor(0, strip.Color(0, 255, 0));strip.show();}
#define LED_RX_OFF() {strip.setPixelColor(0, strip.Color(0, 0, 0));strip.show();}
#define LED_TX_ON() {LED_Color(255, 0, 0);}
#define LED_TX_OFF() {LED_Color(0, 0, 0);}
